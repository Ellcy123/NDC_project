...
| EXP_SC3002_楼顶.md | `u3_exp_rooftop` | 楼顶案发现场，承载护栏、脚印、地面涂油、门内侧把手等跨 Loop 搜证 |
...
公寓楼动线必须具备白天 / 夜晚两版需求：SC3001 楼下入口、SC3016 一楼走廊、SC3006 二楼走廊、SC3015 三楼走廊、SC3019 六楼走廊、SC3002 楼顶。Helen 家因 L3 白天搜证与 L4 夜晚补充指证共用，也写白天 / 夜晚灯光差异。
