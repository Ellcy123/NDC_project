...
| 人物 | 状态 |
|---|---|
| Mickey | 告知判决进展，并把调查方向推向 Bernard |
| Zack | 接受继续取证任务 |
| Emma | 与 Zack 一起准备去银行核查 |
...
- 承接 L4 报社采访中“银行存在诱导”的线索。
- 将 L5 调查目标明确为 Bernard。
- 赋予 Zack / Emma 合理进入银行办公室调查的身份。

## 配置理解

- 这是 L5 开篇 AVG，不是 `EXP_SC3011_Mickey办公室.md` 的 Loop 拆分。
- SC3011 仍可作为后续 L6 控辩地点复用；本文件只描述 L5 开篇镜头。
