...
**state ID**：`1014`（90xx = 场景命名空间；全 6 Loop 共用此 ID）
...
**解锁条件**：L6 在 Morrison 家搜证 + 🎬 Whale 电话事件结束 → Zack 和 Emma 带五件证据（1401、1601、1503、1603、1604）前往警局

### 场景描述
Zack 和 Emma 带着五件证据（1401、1601、1503、1603、1604）来到警察局。Morrison 在自己的办公室里——Zack 选择单独面对他，不公开对质。Emma 站在 Zack 身侧，两人推门进去。
...
### 可获取证据
无（过场 + Expose 入口；本场景不新增物证，使用 Morrison 家 1613 取得的五件证据进入三轮指证）

### 携带证据（carried_evidence — 用于 Expose）
| ID | 来源 | 用途 |
|---|---|---|
| 1401 | L3 Rosa post_expose 继承 | .45 弹壳（Morrison R1 / R2 线索） |
| 1601 | L5 James 自杀现场继承 | 米勒集团特制手枪（R3 凶器闭环） |
| 1503 | L5 James 家 | James 给 Whale 的回信（R3 Whale 关联维度） |
| 1603 | L6 Morrison 家 | 赌债欠条（R2 同时出示） |
| 1604 | L6 Morrison 家 | 借 Whale 钱记录（R2 同时出示） |
