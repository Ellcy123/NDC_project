...
| NPC | is_liar | 关键证词 |
|---|:---:|---|
| Tommy（tommy_l2） | true（L2 Expose 对象；三层退守：只有私酒 → 账目清白 → 古董卖出） | 9052001（⚠谎言：只有私酒 — R1 指证目标）/ 9052002（23:30 枪声从酒吧南方传来——厨房和会客室方向）/ 9052003（身份） |
...
| NPC | is_liar | 关键证词 |
|---|:---:|---|
| Tommy（tommy_L4_001） | false | 9054001（Rita 是 Whale 派来的间谍；疑点 9401 condition）/ 9054002（知道 Whale 的只有前/现勒索人；L5 疑点 9504 condition） |
...
| NPC | is_liar | 关键证词 |
|---|:---:|---|
| Tommy（tommy_004） | false | 9054002（追加：知道 Whale 的只有前/现勒索人——与 L4 同 ID 复用） |
