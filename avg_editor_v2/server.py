...
EDITABLE_FIELDS = {
    ...
    'ItemStaticData': {'ArtRequirement', 'Name', 'itemType', 'description', 'itemUseDes',
                       'canAnalyzed', 'canCombined', 'iconPath', 'folderPath',
                       'desSpritePath', 'mapSpritePath', 'previewAssetMode',
                       'previewAssetNote', 'ActionParam', 'obtainMethod'},
    ...
    'ChapterConfig':  {'ArtRequirement', 'chapterTitle', 'chapterBrief', 'chapterGoal',
                       ...
                       'initTalk', 'initScene', 'openingScene', 'explorationEntryScene',
                       'pendingInitTalkKey'},
