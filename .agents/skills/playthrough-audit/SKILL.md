...
读取 brief 模板：`.Codex/skills/playthrough-audit/references/brief-template.md`
...
读取审计维度定义：`.Codex/skills/playthrough-audit/references/audit-dimensions.md`
...
2. 复制 reference 文件：
   ```bash
   cp .Codex/skills/playthrough-audit/references/styles.css audit-reports/{dir}/
   cp .Codex/skills/playthrough-audit/references/main.js audit-reports/{dir}/
   cp .Codex/skills/playthrough-audit/references/_base.html audit-reports/{dir}/
   cp .Codex/skills/playthrough-audit/references/_footer.html audit-reports/{dir}/
   cp .Codex/skills/playthrough-audit/references/build.sh audit-reports/{dir}/
...
读取 `.Codex/skills/playthrough-audit/references/section-templates.md`，了解每个 section 的 HTML 结构要求。
