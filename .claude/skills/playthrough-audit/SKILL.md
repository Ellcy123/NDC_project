...
```
avg_editor_v2/data/table/ItemStaticData.json      → 证据/道具
avg_editor_v2/data/table/TestimonyItem.json        → 证词
avg_editor_v2/data/table/Testimony.json            → 证词原文
avg_editor_v2/data/table/DoubtConfig.json          → 疑点
avg_editor_v2/data/table/ExposeData.json           → 指证数据
avg_editor_v2/data/table/NPCStaticData.json        → NPC 基础数据
avg_editor_v2/data/table/SceneConfig.json          → 场景配置
avg_editor_v2/data/table/Talk.json                 → 对话索引
avg_editor_v2/data/table/GameFlowConfig.json       → 游戏流程
avg_editor_v2/data/table/NPCLoopData.json          → NPC 循环数据
```
