...
export class TokenCacheManager {
    ...
    constructor() {
        ...
        Object.defineProperty(this, "fieldEncryption", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
     ...
     * @returns 加密后的缓存项
     */
    encryptUserTokenSensitiveFields(cacheItem) {
     ...
     * @returns 解密后的缓存项
     */
    decryptUserTokenSensitiveFields(cacheItem) {
        const data = cacheItem.data;
        return {
            ...cacheItem,
            data: {
     ...
     * @returns 加密后的缓存项
     */
    encryptTenantTokenSensitiveFields(cacheItem) {
        if (!this.fieldEncryption.isEnabled()) {
            return cacheItem; // 未启用加密，直接返回
        }
        const data = cacheItem.data;
     ...
     * @returns 解密后的缓存项
     */
    decryptTenantTokenSensitiveFields(cacheItem) {
        const data = cacheItem.data;
        return {
            ...cacheItem,
            data: {
