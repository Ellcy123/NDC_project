...
```json
{
  "report": "{JOB_PAYLOAD}/qa/review.json",
  "reportSha256": "64-lowercase-hex-characters",
  "preview": "{JOB_PAYLOAD}/qa/review-overlay.png",
  "status": "PASS"
}
```
...
Coordinates use the untouched source-scene canvas. Resolve `{JOB_PAYLOAD}` from `workspace create`, resolve `{PLANNING_ROOT}` and `{ENGINE_ROOT}` through `ndc_art.py paths`, and resolve `{INTEGRATION_SKILL_ROOT}` through `ndc_art.py skill ndc-character-scene-integration`; replace the placeholders with the resolved values in the saved plan. The actor array below shows one complete actor template; repeat it for every simultaneous actor and record all pairwise occlusion entries. Values illustrate the structure only; measure every real scene independently.
...
```json
{
  ...
  "sourceScene": "{ENGINE_ROOT}/path/to/fixed-background.png",
  "sourceSceneSha256": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
  "sceneSize": [2560, 1600],
  "castClusterSide": "right",
  "uiSide": "left",
  "uiReference": "{INTEGRATION_SKILL_ROOT}/assets/ui/dialogue-composition-left.png",
  ...
  "combinedWhitebox": "{JOB_PAYLOAD}/whitebox/combined-whitebox.png",
  "combinedWhiteboxSha256": "eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
  "actorContacts": [],
  "sceneAbsoluteScaleReview": {
    "contract": "{JOB_PAYLOAD}/contracts/scene-absolute-scale.json",
    "report": "{JOB_PAYLOAD}/qa/scene-absolute-scale-report.json",
    "reportSha256": "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",
    "preview": "{JOB_PAYLOAD}/qa/scene-absolute-scale-overlay.png",
    "status": "PASS",
  ...
  "castScaleReview": {
    "contract": "{JOB_PAYLOAD}/contracts/cast-scale.json",
    "report": "{JOB_PAYLOAD}/qa/cast-scale-report.json",
  ...
  "whiteboxVisualReview": {
    "report": "{JOB_PAYLOAD}/qa/whitebox-visual-review.json",
    "reportSha256": "2222222222222222222222222222222222222222222222222222222222222222",
    "preview": "{JOB_PAYLOAD}/qa/whitebox-review-board.png",
    "status": "PASS",
  ...
  "outputPsd": "{JOB_PAYLOAD}/output/final.psd",
  "outputPng": "{JOB_PAYLOAD}/output/final.png",
  "actors": [
    {
      "actorId": "205",
      "name": "Mickey Donnelly",
      "presenceAtSnapshot": "already-present",
      "characterCard": "{PLANNING_ROOT}/path/to/mickey-card.png",
      "characterCardSha256": "3333333333333333333333333333333333333333333333333333333333333333",
      "canonicalHeightCm": 183,
      "canonicalHeightSource": "{PLANNING_ROOT}/path/to/mickey.md",
      ...
      "isolatedWhitebox": "{JOB_PAYLOAD}/whitebox/mickey-isolated.png",
      ...
      "supportContactReview": {
        "report": "{JOB_PAYLOAD}/qa/mickey-support-report.json",
        "reportSha256": "6666666666666666666666666666666666666666666666666666666666666666",
        "preview": "{JOB_PAYLOAD}/qa/mickey-support-overlay.png",
        "status": "PASS"
      },
      "prop": null
    }
...
```json
{
  "contextualCandidate": "{JOB_PAYLOAD}/candidates/actor-context.png",
  "rawCutout": "{JOB_PAYLOAD}/extraction/actor-cutout.png",
